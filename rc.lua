...
table.insert(mainmenu, {"terminal", "gnome-terminal", "/usr/share/icons/Humanity/apps/48/gnome-terminal.svg"});
table.insert(mainmenu, {"chromium", "chromium-browser","/usr/share/icons/hicolor/128x128/apps/chromium-browser.png"});
table.insert(mainmenu, {"restart", awesome.restart,"/usr/share/icons/Humanity/apps/48/system-restart.svg"});
table.insert(mainmenu, {"Poweroff", "sudo /sbin/poweroff", "/usr/share/icons/Humanity/actions/48/application-exit.svg"});
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "g",      function () awful.util.spawn(terminal) end),
